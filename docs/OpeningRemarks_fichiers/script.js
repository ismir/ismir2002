...
var ENDSHOW_MESG="Fin du diaporama, cliquez pour quitter.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=10, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0007.htm", 1, 3),
   new hrefList("slide0008.htm", 1, 4),
   new hrefList("slide0004.htm", 1, 5),
   new hrefList("slide0009.htm", 1, 6),
